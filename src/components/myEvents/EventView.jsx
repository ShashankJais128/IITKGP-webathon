                    ...
                    <div className="bg-[#28282B] pt-5 pb-10 px-6 sm:px-12 ">
                      ...
                      <div>
                        <p className="text-justify text-base sm:text-lg md:text-2xl text-white">
                          ...
                          elit. Recusandae aliquam mollitia temporibus? Ratione
                          at enim sed laudantium blanditiis consequatur, dolore
                          non. Laboriosam nam reprehenderit, a facere eaque modi
                          sit placeat vero perferendis explicabo, tenetur, ea
                          odit sint doloribus facilis. Saepe quidem sed
                          aspernatur officiis nesciunt labore deserunt
                          cupiditate aperiam ipsum impedit vitae dolores rem
                          ipsa, mollitia, quisquam, excepturi nam dignissimos!
                          Eaque suscipit odio dolorem enim nesciunt
                          reprehenderit sequi, reiciendis, optio inventore
                          dolorum autem mollitia. Assumenda voluptate provident
                          voluptatum beatae culpa asperiores iusto dicta maiores
                          reprehenderit nulla quisquam officiis ducimus, earum
                          quasi sequi veniam eligendi, quae expedita dolorum?
                          Saepe, iure autem!
                        </p>
                      </div>
                      <br />
